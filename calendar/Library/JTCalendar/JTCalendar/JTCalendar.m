...
- (void)reloadData
{
    ...
    button1.frame = CGRectMake(pageWidth * 2 + 12, 18, 8, 14);
    [button1 addTarget:self action:@selector(loadPreviousMonth) forControlEvents:UIControlEventTouchUpInside];
    [button1 setBackgroundImage:[UIImage imageNamed:@"arrow2.png"] forState:UIControlStateNormal];
